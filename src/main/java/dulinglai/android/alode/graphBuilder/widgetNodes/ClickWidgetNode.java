...
public class ClickWidgetNode extends AbstractWidgetNode {
...
//    public ClickWidgetNode(int resourceId, String resString, String text) { super(resourceId,resString,text); }
    ...
    public ClickWidgetNode(int resourceId, String text, EventType eventType, String clickListener) {
        super(resourceId, text);
        this.eventType = eventType;
        this.clickListener = clickListener;
    }

    public ClickWidgetNode(int resourceId, String resString, String text, EventType eventType, String clickListener) {
    ...
    public boolean equals(Object obj) {
        ...
        ClickWidgetNode other = (ClickWidgetNode) obj;
