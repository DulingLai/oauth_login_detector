 ...
 * of memory. Inspired by code from http://www.javaspecialists.eu/archive/Issue092.html.
 * 
...
public class MemoryWarningSystem {
	...
	public MemoryWarningSystem() {
		...
		((NotificationEmitter) memoryBean).addNotificationListener(memoryListener,
	...
	/**
	 * Adds a listener that is called when the memory usage threshold defined
	 * using setWarningThreshold() has been reached
	...
	/**
	 * Sets the one single global warning threshold for memory usage. If at
	 * least the given fraction of the overall tenured pool is in use, the
	 * registered hanlders will be invoked.
	 * @param percentage
	 */
	...
	/**
	 * Closes this warning system instance. It will no longer notify any
	 * listeners of memory shortages.
	 */
	public void close() {
