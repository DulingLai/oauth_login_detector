...
public class ComponentConstants {
    ...
    private static final String[] clickListenerMethods = {CLICKLISTENER_ONCLICK};
    private static final List<String> clickListenerMethodList = Arrays.asList(clickListenerMethods);
    ...
    public static List<String> getClickListenerMethodList() { return clickListenerMethodList; }
